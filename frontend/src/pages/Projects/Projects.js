    ...
    <>
      <div className="container project" id="project">
        ...
        <p className="pb-3 text-center">
          ...
          Practical full-stack applications developed using MERN technologies, focusing on clean code, reusability, and optimized user experience.
        </p>
        {/* card design */}
            ...
            <div className="card rounded">
              ...
              <div className="card-body text-center">
                <div className="ad-title m-auto">
                  <h5 className="text-uppercase">Book My Show App</h5>
                </div>
                <a className="ad-btn" href="https://book-my-show-dw4g.vercel.app/" target="_blank">View</a>
              </div>
            </div>
          </div>
          <div className="col-md-4">
